...
function CourseCell({ course }: { course: OrgCourseRow }) {
  return (
...
function InstructorsCell({ course }: { course: OrgCourseRow }) {
...
function CategoriesCell({ course }: { course: OrgCourseRow }) {
...
const columnHelper = createColumnHelper<OrgCourseRow>();

export const ORG_COURSE_COLUMNS = [
  ...
  columnHelper.display({
    id: "actions",
    header: "",
    cell: ({ row }) => <OrgCourseActions course={row.original} />,
