...
export function OrgInvitationsToolbar({
  isFetching = false,
  onRefresh,
  onSearchChange,
  search,
}: OrgInvitationsToolbarProps): ReactNode {
  return (
    <div className="flex items-center gap-2">
      <div className="min-w-0 flex-1">
        <label className="sr-only" htmlFor="org-invitations-search">
          Search by email
        </label>
