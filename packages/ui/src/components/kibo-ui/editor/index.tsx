...
import { Command, CommandEmpty, CommandItem, CommandList } from "@sycom/ui/components/command";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export const EditorSelector = ({
  ...
  return (
    <Popover onOpenChange={onOpenChange} open={open}>
      <PopoverTrigger
        render={<Button className="gap-2 rounded-none border-none" size="sm" variant="ghost" />}
      >
